...
<header class="wp-block-group qw-section qw-section--cream qw-nav has-text-color has-background" style="border-bottom-color:var(--wp--preset--color--teal);border-bottom-style:solid;border-bottom-width:1px;background-color:var(--wp--preset--color--cream);color:var(--wp--preset--color--ink-deep)">
	...
	<div class="wp-block-group">
		...
		<!-- wp:heading {"level":1,"className":"qw-wordmark","style":{"typography":{"fontFamily":"var:preset|font-family|cormorant","fontStyle":"italic","fontWeight":"300","fontSize":"var:preset|font-size|2xl","lineHeight":"1","letterSpacing":"-0.02em"},"color":{"text":"var:preset|color|ink-deep"}}} -->
		<h1 class="wp-block-heading qw-wordmark" style="font-family:var(--wp--preset--font-family--cormorant);font-size:var(--wp--preset--font-size--2xl);font-style:italic;font-weight:300;line-height:1;letter-spacing:-0.02em;color:var(--wp--preset--color--ink-deep)">Quillwork</h1>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button">
					<a class="wp-block-button__link wp-element-button" href="#" style="border-radius:0;background-color:var(--wp--preset--color--teal);color:var(--wp--preset--color--cream)">Start a project</a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
